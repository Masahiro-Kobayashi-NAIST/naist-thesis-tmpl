...
\newcommand{\studentnumber}{}  % 学籍番号←空欄にする
\newcommand{\jprogram}{情報理工学プログラム}  % 所属プログラム
\newcommand{\firstcmember}{AA AA}  % 主指導教員
\newcommand{\jlabname}{ZZ研究室}
\newcommand{\elabname}{ZZ Laboratory}
\newcommand{\jtitle}{日本語の題名}  % 修論の題名
\newcommand{\etitle}{English Title}     % 英語の題名
\newcommand{\jauthor}{XX XX}      % 著者名
\newcommand{\eauthor}{XX XX} % 英語の著者名
\newcommand{\jdate}{\warekisetdate{\year}{\month}{\day}\warekidate} % 日付
